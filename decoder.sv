...
module decoder (
    ...
    always_comb begin
        if (opcode == OP_AL_REG) begin
            ...
            conditional = 1'b0;
            nextpc_select = 1'b1;
            imm = {{11{instruction[31]}}, instruction[31], instruction[19:12], instruction[30], instruction[29:20], 1'b0};
            ...
            conditional = 1'b0;
            nextpc_select = 1'b0;
            imm = {instruction[31:12], 12'b0}; // already shifted
