...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vpc___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vpc___024root___eval_phase__stl(Vpc___024root* vlSelf);
...
#ifdef VL_DEBUG
            Vpc___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
#endif
            VL_FATAL_MT("pc.sv", 4, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        vlSelfRef.__VstlPhaseResult = Vpc___024root___eval_phase__stl(vlSelf);
        vlSelfRef.__VstlFirstIteration = 0U;
    } while (vlSelfRef.__VstlPhaseResult);
}

VL_ATTR_COLD bool Vpc___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in);

#ifdef VL_DEBUG
VL_ATTR_COLD void Vpc___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpc___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vpc___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vpc___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpc___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD bool Vpc___024root___eval_phase__stl(Vpc___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpc___024root___eval_phase__stl\n"); );
    Vpc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
#endif
    __VstlExecute = Vpc___024root___trigger_anySet__stl(vlSelfRef.__VstlTriggered);
    if (__VstlExecute) {
        {
...
VL_ATTR_COLD void Vpc___024root___ctor_var_reset(Vpc___024root* vlSelf) {
    ...
    vlSelf->nextpc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 5275156443315785927ull);
    vlSelf->currentpc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 1917819355521208406ull);
    vlSelf->pc__DOT__pc_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 901560070611312048ull);
